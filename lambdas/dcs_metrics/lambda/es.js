...
// assert(SEARCH_CIDS_INDEX, 'Undefined env SEARCH_CIDS_INDEX')
// assert(SEARCH_DCS_GOES_INDEX, 'Undefined env SEARCH_CIDS_INDEX')
// assert(SEARCH_DCS_IRIDIUM_INDEX, 'Undefined env SEARCH_DCS_IRIDIUM_INDEX')
assert(SEARCH_DCS_METRICS_INDEX, 'Undefined env SEARCH_DCS_METRICS_INDEX')
